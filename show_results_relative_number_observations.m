...
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_MI_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_MI_withresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_POS_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_POS_withresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_watson_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_watson_withresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_logregress_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_logregress_withresampling');

load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_MI_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_MI_withoutresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_POS_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_POS_withoutresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_watson_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_watson_withoutresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_sensitivity_logregress_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'sensitivity_logregress_withoutresampling');

load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_MI_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_MI_withresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_POS_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_POS_withresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_watson_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_watson_withresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'With_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_logregress_withresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_logregress_withresampling');

load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_MI_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_MI_withoutresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_POS_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_POS_withoutresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_watson_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_watson_withoutresampling');
load(strcat([root_dir 'Relative_trial_number' filesep 'Without_resampling' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep cfg_simulations.oscillation '_coupling_mode' num2str(cfg_simulations.coupling_mode) '_FPrate_logregress_withoutresampling_phase_outcome_coupling' num2str(cfg_simulations.poc_relative_trial_number) '.mat']), 'FPrate_logregress_withoutresampling');
