...
if strcmp(cfg_simulations.oscillation, 'alpha')
    ...
    load(strcat([root_dir 'alpha_phase_all_subjects.mat']));
    phase_all_subjects = alpha_phase_all_subjects;
    
elseif strcmp(cfg_simulations.oscillation, 'EGG')
    
    fprintf('\n##### Loading EGG phase time series...\n');
    load(strcat([root_dir 'EGG_phase_all_subjects.mat']));
    phase_all_subjects = EGG_phase_all_subjects;
...
%%% 3. Comparing permutation statistics with tabulated statistics
