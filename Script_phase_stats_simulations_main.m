...
%%% https://github.com/anne-urai/Tools/tree/master/CircStat2012a
%%%
...
root_dir = strcat(['C:\Phase_stats_Github_Scripts' filesep]);

% Specify path to circular statistics toolbox
path_circstats = strcat(['C:\Phase_stats_Github_Scripts\CircStat2012a' filesep]);
...
if strcmp(cfg_simulations.oscillation, 'alpha')
    ...
    for isubject=1:30
        ...
        load(strcat([root_dir 'Phase_time_series' filesep cfg_simulations.oscillation filesep 'Subject' num2str(isubject,'%02.f') '_alpha_phase.mat']));
...
elseif strcmp(cfg_simulations.oscillation, 'EGG')
    ...
    for isubject=1:30
        ...
        load(strcat([root_dir 'Phase_time_series' filesep cfg_simulations.oscillation filesep 'Subject' num2str(isubject,'%02.f') '_EGG_phase.mat']));
        phase_all_subjects{isubject} = alpha_phase;
...
show_results_chance_level_mean_vs_median(cfg_simulations, root_dir)
...
parfor iexp=1:nexperiments
    ...
    comp_stats_per_relative_number_observations(cfg_simulations, iexp, nTrials_total, phase_all_subjects, root_dir, ISI_range);
