...
for isubject=1:nsubjects
    ...
    for ipoc=1:length(cfg_simulations.strengths_phase_outcome_coupling)
        ...
        [MIs_empirical(isubject, ipoc), POS_empirical(isubject, ipoc), U2watson_empirical(isubject, ipoc), rms_logregress_empirical(isubject, ipoc), watson_pvalues_direct(isubject, ipoc), logregress_pvalues_direct(isubject, ipoc)] = calc_phase_statistics(phases_hits, phases_misses, cfg_simulations, 0);
        
        [MIs_surr_distr{isubject, ipoc}, POS_surr_distr{isubject, ipoc}, U2watson_surr_distr{isubject, ipoc}, rms_logregress_surr_distr{isubject, ipoc}] = calc_chance_level_statistics(phases_hits,phases_misses,cfg_simulations, 0);
