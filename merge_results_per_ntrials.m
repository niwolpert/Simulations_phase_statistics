...
pvalues_rayleigh_effectpresent = nan(nexperiments, length(cfg_simulations.levels_nTrials));
...
for iexp=1:nexperiments
    ...
    if isfile(strcat([root_dir 'Number_of_trials' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep 'Empirical' filesep cfg_simulations.oscillation filesep cfg_simulations.oscillation '_MIs_empirical_effectpresent_phaseoutcome_coupling' num2str(cfg_simulations.poc_simulations_Ntrials) '_experiment' num2str(iexp) '.mat']))
        ...
        for iTrials=1:length(cfg_simulations.levels_nTrials)
            ...
            [~, pvalues_rayleigh_effectpresent(iexp, iTrials)] = ttest(z_rayleigh_empirical_effectpresent(:, iTrials), z_rayleigh_chance_levels_effectpresent(:, iTrials), 'tail', 'right');
...
pvalues_rayleigh_effectabsent = nan(nexperiments, length(cfg_simulations.levels_nTrials));
...
for iexp=1:nexperiments
    ...
    if isfile(strcat([root_dir 'Number_of_trials' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep 'Empirical' filesep cfg_simulations.oscillation filesep cfg_simulations.oscillation '_MIs_empirical_effectabsent_phaseoutcome_coupling' num2str(cfg_simulations.poc_simulations_Ntrials) '_experiment' num2str(iexp) '.mat']))
        ...
        for iTrials=1:length(cfg_simulations.levels_nTrials)
            ...
            [~, pvalues_rayleigh_effectabsent(iexp, iTrials)] = ttest(z_rayleigh_empirical_effectabsent(:, iTrials), z_rayleigh_chance_levels_effectabsent(:, iTrials), 'tail', 'right');
...
FPrate_ntrials_rayleigh = nan(1, length(cfg_simulations.levels_nTrials));
...
for iTrials=1:length(cfg_simulations.levels_nTrials)
    ...
    FPrate_ntrials_rayleigh(iTrials) = length(find(pvalues_rayleigh_effectabsent(:, iTrials)<signific_thresh))/length(find(~isnan(pvalues_rayleigh_effectabsent(:, iTrials))));
...
save(strcat([root_dir 'Number_of_trials' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep 'FPrate' filesep cfg_simulations.oscillation filesep cfg_simulations.oscillation '_FPrate_ntrials_POS_noise_level' num2str(cfg_simulations.poc_simulations_Ntrials) '.mat']), 'FPrate_ntrials_POS');
save(strcat([root_dir 'Number_of_trials' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep 'FPrate' filesep cfg_simulations.oscillation filesep cfg_simulations.oscillation '_FPrate_ntrials_z_rayleigh_noise_level' num2str(cfg_simulations.poc_simulations_Ntrials) '.mat']), 'FPrate_ntrials_rayleigh');
save(strcat([root_dir 'Number_of_trials' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep 'FPrate' filesep cfg_simulations.oscillation filesep cfg_simulations.oscillation '_FPrate_ntrials_U2watson_noise_level' num2str(cfg_simulations.poc_simulations_Ntrials) '.mat']), 'FPrate_ntrials_watson');
save(strcat([root_dir 'Number_of_trials' filesep 'Mode' num2str(cfg_simulations.coupling_mode) filesep 'FPrate' filesep cfg_simulations.oscillation filesep cfg_simulations.oscillation '_FPrate_ntrials_rms_logregress_noise_level' num2str(cfg_simulations.poc_simulations_Ntrials) '.mat']), 'FPrate_ntrials_logregress');
...
sensitivity_ntrials_rayleigh = nan(1, length(cfg_simulations.levels_nTrials));
...
for iTrials=1:length(cfg_simulations.levels_nTrials)
    ...
    sensitivity_ntrials_rayleigh(iTrials) = length(find(pvalues_rayleigh_effectpresent(:, iTrials)<signific_thresh))/length(find(~isnan(pvalues_rayleigh_effectpresent(:, iTrials))));
