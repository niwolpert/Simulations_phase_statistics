function [MI, POS, U2_watson, rms_logregress, p_watson_direct, p_logregress_direct] = calc_phase_statistics(phases_hits, phases_misses, cfg_simulations, nresamples)
