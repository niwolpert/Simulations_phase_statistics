    ...
    for effectabsent=0:1
        ...
        for iTrials=1:length(cfg_simulations.levels_nTrials)
            ...
            if effectabsent
                ...
                [MIs_empirical_effectabsent(isubject, iTrials), POS_empirical_effectabsent(isubject, iTrials), U2watson_empirical_effectabsent(isubject, iTrials), rms_logregress_empirical_effectabsent(isubject, iTrials)] = calc_phase_statistics(phases_hits, phases_misses, cfg_simulations, 0);

                [MIs_surr_distr_effectabsent{isubject, iTrials}, POS_surr_distr_effectabsent{isubject, iTrials}, U2watson_surr_distr_effectabsent{isubject, iTrials}, rms_logregress_surr_distr_effectabsent{isubject, iTrials}] = calc_chance_level_statistics(phases_hits, phases_misses, cfg_simulations, 0);
                ...
                [MIs_empirical_effectpresent(isubject, iTrials), POS_empirical_effectpresent(isubject, iTrials), U2watson_empirical_effectpresent(isubject, iTrials), rms_logregress_empirical_effectpresent(isubject, iTrials)] = calc_phase_statistics(phases_hits, phases_misses, cfg_simulations, 0);

                [MIs_surr_distr_effectpresent{isubject, iTrials}, POS_surr_distr_effectpresent{isubject, iTrials}, U2watson_surr_distr_effectpresent{isubject, iTrials}, rms_logregress_surr_distr_effectpresent{isubject, iTrials}] = calc_chance_level_statistics(phases_hits,phases_misses,cfg_simulations,0);
