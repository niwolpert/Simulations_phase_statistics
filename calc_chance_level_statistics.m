function [MIs_surr, POS_surr, U2watson_surr, rms_logregress_surr] = calc_chance_level_statistics(phases_hits, phases_misses, cfg_simulations, nresamples)
...
for isurr=1:cfg_simulations.nperm
    ...
    [MIs_surr(isurr), POS_surr(isurr), U2watson_surr(isurr), rms_logregress_surr(isurr)] = calc_phase_statistics(phases_hits_perm, phases_misses_perm, cfg_simulations, nresamples);
