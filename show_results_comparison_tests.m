...
if strcmp(method_estimate_significance, 'empirical_vs_chance')
    ...
    fp_z_rayleigh = fp_empirical_vs_chance_z_rayleigh;
    ...
    sensitivity_z_rayleigh = sensitivity_empirical_vs_chance_z_rayleigh;
...
elseif strcmp(method_estimate_significance, 'surravg')
    ...
    fp_z_rayleigh = fp_surravg_z_rayleigh;
    fp_MI = fp_surravg_MI;
    ...
    sensitivity_z_rayleigh = sensitivity_surravg_z_rayleigh;
...
elseif strcmp(method_estimate_significance, 'combined_stouffer')
    ...
    fp_z_rayleigh = fp_combined_stouffer_z_rayleigh;
    ...
    sensitivity_z_rayleigh = sensitivity_combined_stouffer_z_rayleigh;
...
elseif strcmp(method_estimate_significance, 'combined_fisher')
    ...
    fp_z_rayleigh = fp_combined_fisher_z_rayleigh;
    ...
    sensitivity_z_rayleigh = sensitivity_combined_fisher_z_rayleigh;
...
elseif strcmp(method_estimate_significance, 'combined_edington')
    ...
    fp_z_rayleigh = fp_combined_edington_z_rayleigh;
    ...
    sensitivity_z_rayleigh = sensitivity_combined_edington_z_rayleigh;
...
r=plot(sensitivity_z_rayleigh(2:end), 'Color', colors{4}, 'Linewidth', 3); hold on;
m=plot(sensitivity_MI(2:end),'Color',  colors{5}, 'Linewidth', 3); hold on;
xticks(1:8);
xticklabels({'5','10','15','20','25','30','35','40'});
lgd=legend([m p r u l], 'MI', 'POS', 'Rayleigh', 'Watson', 'circ. log. regr.', 'Location','northeast');
lgd.FontSize = 15;
ax = gca;
ax.FontSize = 16;
xlim([1 8]);
...
r=bar(4, fp_z_rayleigh); set(r,'FaceColor', colors{4}); hold on;
m=bar(5, fp_MI); set(m,'FaceColor', colors{5}); hold on;
hline(0.05, '--k');
xlim([0.4 5.6]);
ylim([0 0.06]);
xticks(1:5);
xticklabels({'Cir. log. regr.','POS','Watson','Rayleigh','MI'});
xtickangle(45);
